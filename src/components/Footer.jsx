const Footer = () => {
    return (
        <footer className="flex items-center justify-between gap-4 bg-[#93a74d] px-5 py-4">
            <p className="[font-family:var(--font-dm-sans)] text-[#f7edcc] text-sm font-semibold">
                © 2026 KitchenLogs. All rights reserved.
            </p>

            <div className="flex items-center gap-2 text-(--foreground)">
                <a href="#" aria-label="Instagram" className="inline-flex size-8 items-center justify-center">
                ...
                <a href="#" aria-label="Facebook" className="inline-flex size-8 items-center justify-center">
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="size-4">
                ...
                <a href="#" aria-label="X" className="inline-flex size-8 items-center justify-center">
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="size-4">
