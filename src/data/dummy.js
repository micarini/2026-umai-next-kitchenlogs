const recipes = [
  ...
  },
  {
    ...
    instructions: [
      ...
      "Add minced ginger and garlic, saute until fragrant.",
  ...
  },
  {
    ...
    instructions: [
      ...
      "In a pan, saute sliced chicken in butter until fully cooked.",
  ...
  },
  {
    ...
    instructions: [
      ...
      "In a skillet, saute minced garlic in olive oil until fragrant.",
  ...
  },
  {
    ...
    instructions: [
      ...
      "In a pot, saute sliced onions until golden brown. Remove half for later use.",
  ...
  },
  {
    ...
    instructions: [
      "In a wok (karahi), heat cooking oil and saute minced garlic until golden brown.",
  ...
  },
  {
    ...
    instructions: [
      "In a pan, heat cooking oil and saute chopped onions until golden brown.",
  ...
  },
  {
    ...
    instructions: [
      ...
      "In a pan, saute chopped onions, green chilies, and grated ginger in ghee until golden brown.",
  ...
  },
  {
    ...
    instructions: [
      "In a tagine or large pot, saute chopped onions and minced garlic until softened.",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Top with beef bulgogi, sauteed carrots, seasoned spinach, grilled zucchini, and blanched bean sprouts.",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Saute sliced eggplants in olive oil until browned. Set aside.",
      ...
      "In a separate saucepan, make bechamel sauce: melt butter, whisk in flour, add milk, and cook until thickened.",
      "Remove from heat and stir in Parmesan cheese and egg yolks.",
      "In a baking dish, layer eggplants and meat mixture. Top with bechamel sauce.",
  ...
  },
  {
    ...
    instructions: [
      ...
      "In a pan, melt butter and saute the marinated chicken until browned.",
